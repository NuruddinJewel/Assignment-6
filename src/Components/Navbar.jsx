        ...
        <div>
            <nav className="navbar bg-base-100 shadow-sm px-8 py-4 flex items-center justify-between">
                 ...
                 <div className="flex items-center gap-6">
                   <FiShoppingCart className="text-xl cursor-pointer text-gray-700" />
                   <button className="text-gray-700 font-medium hover:text-black cursor-pointer btn">Login</button>
                   <button className=" btn bg-linear-to-r from-[#8B5CF6] to-[#6D28D9] text-white px-6 py-2 rounded-full font-semibold hover:opacity-90 transition-opacity cursor-pointer">
                     Get Started
                   </button>
                 </div>
               </nav> 
